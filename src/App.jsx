...
function App() {
  ...
  return (
    <main className={`relative flex flex-col md:flex-row w-full min-w-72  bg-${theme[configTheme]}`}>
      {/* Button Theme */}
      <Theme theme={theme} handleTheme={handleTheme} configTheme={configTheme} />
      {/* Aside Left */}
      <Aside theme={theme} configTheme={configTheme} />
      {/* Main */}
      <section className="relative lg:fixed lg:w-[65%] xl:w-[calc(100%_-_410px)] flex ml-auto ">
